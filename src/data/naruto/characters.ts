...
export const narutoCharacters: Character[] = [
  /* ===================== MAIN ===================== */
  {
    ...
    jutsuIds: [
      ...
      'jutsu-sage-mode-toad', 'jutsu-sage-mode-six-paths',
      'jutsu-tailed-beast-ball', 'jutsu-kurama-chakra-mode',
      'jutsu-truth-seeker-orbs', 'jutsu-henge', 'jutsu-kawarimi', 'jutsu-shunshin',
    ],
  ...
  },
  {
    ...
    jutsuIds: [
      'jutsu-sharingan', 'jutsu-mangekyou-sharingan', 'jutsu-eternal-mangekyou-sharingan',
      'jutsu-rinnegan', 'jutsu-chidori', 'jutsu-amaterasu', 'jutsu-tsukuyomi', 'jutsu-susanoo',
      'jutsu-izanagi', 'jutsu-izanami', 'jutsu-katon-fireball', 'jutsu-katon-phoenix-sage-fire',
      'jutsu-henge', 'jutsu-kawarimi', 'jutsu-shunshin', 'jutsu-truth-seeker-orbs', 'jutsu-indra-arrow',
    ],
  ...
  },
  {
    ...
    jutsuIds: [
      'jutsu-sharingan', 'jutsu-mangekyou-sharingan', 'jutsu-kamui',
      'jutsu-chidori', 'jutsu-kage-bunshin', 'jutsu-henge', 'jutsu-kawarimi', 'jutsu-shunshin',
    ],
