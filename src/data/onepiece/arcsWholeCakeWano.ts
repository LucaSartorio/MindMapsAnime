...
export const onepieceArcsWholeCakeWano: StoryArc[] = [
  {
    ...
    eventIds: ['evt-op-sanji-rescue', 'evt-op-katakuri-duel', 'evt-op-wci-vinsmoke', 'evt-op-wci-wedding', 'evt-op-wci-pedro'],
    canon: 'canon',
    canonStatus: 'canon',
  ...
  },
  {
    ...
    eventIds: ['evt-op-oden-legacy', 'evt-op-onigashima-war', 'evt-op-kaido-defeat', 'evt-op-wano-act1', 'evt-op-wano-roof', 'evt-op-wano-gear5'],
    canon: 'canon',
    canonStatus: 'canon',
    referenceStatus: 'verified',
