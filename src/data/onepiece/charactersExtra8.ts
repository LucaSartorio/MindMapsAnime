...
export const onepieceCharactersExtra8: Character[] = [
  ...
  C({
    ...
    allies: ['char-op-tama', 'char-op-luffy'], enemies: ['char-op-holdem'], relationships: [{ targetCharacterId: 'char-op-tama', label: "Chi l'ha ammansita coi dango" }],
    fm: '914', fa: '903',
  ...
  C({
    ...
    arcIds: ['arc-op-wano'],
    allies: ['char-op-luffy', 'char-op-tama', 'char-op-hyogoro'], relationships: [{ targetCharacterId: 'char-op-tama', label: 'Bambina che accudisce' }],
    fm: '911', fa: '901',
  ...
  C({
    ...
    allies: ['char-op-vivi', 'char-op-luffy'], relationships: [{ targetCharacterId: 'char-op-vivi', label: 'Padrona e amica' }],
    fm: '127', fa: '78',
