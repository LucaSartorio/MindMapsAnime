...
export const onepieceBounties: Record<string, BountyEntry[]> = {
  ...
  'char-op-chinjao': [b('500.000.000', '716', '649', 'ai tempi di Garp, ormai ritirato', "in Garp's era, now retired")],
  'char-op-ideo': [b('220.000.000', '719', '649', 'capo della 4ª divisione della Grand Fleet', "leader of the Grand Fleet's 4th division")],
  'char-op-orlumbus': [b('148.000.000', '719', '649', 'ammiraglio della flotta Yonta Maria', 'admiral of the Yonta Maria fleet')],
  'char-op-suleiman': [b('86.000.000', '714', '649', '«il Decapitatore»', "'the Beheader'")],
