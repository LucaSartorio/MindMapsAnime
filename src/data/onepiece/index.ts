...
const onepiecePoneglyphs: Record<string, PoneglyphRef> = {
  ...
  'loc-op-fishman-island': { kind: 'road', note: { it: "Road Poneglyph nella Foresta Marina, accanto al Poneglyph delle scuse di Joy Boy; Robin lo decifrò.", en: "Road Poneglyph in the Sea Forest, beside Joy Boy's apology Poneglyph; Robin deciphered it." }, inscription: { it: "Una delle quattro coordinate per Laugh Tale. Accanto sorge il Poneglyph Ryugu: la lettera con cui Joy Boy, nel Secolo Vuoto, chiese scusa a Poseidon per non aver mantenuto il loro patto.", en: "One of the four coordinates to Laugh Tale. Beside it stands the Ryugu Poneglyph: Joy Boy's letter apologizing to Poseidon for failing to keep their pact during the Void Century." } },
  'loc-op-fm-sea-forest': { kind: 'road', note: { it: "Uno dei quattro Road Poneglyph; vi sorge anche il Poneglyph delle scuse di Joy Boy.", en: "One of the four Road Poneglyphs; Joy Boy's apology Poneglyph also stands here." }, inscription: { it: "Coordinata verso Laugh Tale; accanto, le scuse di Joy Boy alla Principessa Sirena Poseidon.", en: "A coordinate toward Laugh Tale; beside it, Joy Boy's apology to the Mermaid Princess Poseidon." } },
  // Zou — Road Poneglyph affidato ai Mink dai Pirati di Roger
  'loc-op-zou': { kind: 'road', note: { it: "Road Poneglyph affidato dai Pirati di Roger ai Mink e custodito per secoli; Robin ne prese un calco.", en: "Road Poneglyph entrusted by Roger's Pirates to the Minks and guarded for centuries; Robin took a rubbing." }, inscription: { it: "Una delle quattro coordinate che, unite, tracciano la rotta finale verso Laugh Tale.", en: "One of the four coordinates that, combined, chart the final route to Laugh Tale." } },
