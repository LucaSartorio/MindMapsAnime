...
export const dragonballRoutes: Route[] = [
  ...
  {
    id: 'route-dbz-gt-baby-journey',
    worldId: 'world-dragonball',
    type: 'faction',
    name: 'Dragon Ball GT · Baby Saga',
    localizedName: { it: 'Dragon Ball GT · Saga di Baby', en: 'Dragon Ball GT · Baby Saga' },
    group: { it: 'Dragon Ball GT', en: 'Dragon Ball GT' },
    description: {
      it: "Dragon Ball GT: il parassita Tsufuru Baby prende possesso di Vegeta alla Capsule Corp, contamina l'intera Terra e trasferisce la popolazione sul Nuovo Pianeta Plant, dove Goku Super Saiyan 4 lo sconfigge. Attraversa la mappa della Terra e la sotto-mappa «Spazio (GT)».",
      en: "Dragon Ball GT: the Tuffle parasite Baby possesses Vegeta at Capsule Corp, infects all of Earth and moves the population to New Planet Plant, where Super Saiyan 4 Goku defeats him. Spans the Earth map and the 'Space (GT)' sub-map.",
    },
    protagonistCharacterIds: ['char-dbz-gt-baby', 'char-dbz-goku'],
    relatedCharacterIds: ['char-dbz-vegeta', 'char-dbz-gt-pan', 'char-dbz-gt-majuub'],
    relatedArcIds: ['arc-dbz-gt-baby'],
    relatedLocationIds: ['loc-dbz-capsule-corp', 'loc-dbz-satan-city', 'loc-dbz-gt-space-gate', 'loc-dbz-gt-earth-gate', 'loc-dbz-gt-new-plant'],
    steps: [
      // — Livello Terra —
      { order: 1, locationId: 'loc-dbz-capsule-corp', eventId: 'evt-dbz-gt-baby-vegeta', label: { it: '1 · Capsule Corp — Baby possiede Vegeta', en: '1 · Capsule Corp — Baby possesses Vegeta' } },
      { order: 2, locationId: 'loc-dbz-satan-city', label: { it: '2 · Terra contaminata', en: '2 · Earth infected' }, description: { it: "Baby contagia quasi l'intera popolazione terrestre.", en: "Baby infects nearly all of Earth's population." } },
      { order: 3, locationId: 'loc-dbz-gt-space-gate', label: { it: '3 · Verso il Nuovo Pianeta Plant', en: '3 · Toward New Planet Plant' }, description: { it: 'Doppio clic sul pin «Spazio (GT)» per salire alla sotto-mappa.', en: "Double-click the 'Space (GT)' pin to go up to the sub-map." } },
      // — Sotto-mappa «Spazio (GT)» —
      { order: 4, locationId: 'loc-dbz-gt-earth-gate', label: { it: '4 · Partenza dalla Terra', en: '4 · Departing Earth' } },
      { order: 5, locationId: 'loc-dbz-gt-new-plant', eventId: 'evt-dbz-gt-goku-ssj4-vs-baby', label: { it: '5 · Nuovo Pianeta Plant — Goku SSJ4 contro Baby', en: '5 · New Planet Plant — SSJ4 Goku vs. Baby' } },
    ],
    color: '#e67e22',
    lineStyle: 'dashed',
    referenceStatus: 'verified',
  ...
  {
    id: 'route-dbz-gt-super-17-journey',
    worldId: 'world-dragonball',
    type: 'faction',
    name: 'Dragon Ball GT · Super 17 Saga',
    ...
    relatedCharacterIds: ['char-dbz-gt-super-17', 'char-dbz-gt-hell-fighter-17', 'char-dbz-android-17'],
    relatedArcIds: ['arc-dbz-gt-super-17'],
    relatedLocationIds: ['loc-dbz-gt-hell', 'loc-dbz-gero-lab', 'loc-dbz-satan-city', 'loc-dbz-lookout'],
    steps: [
      // — Sotto-mappa cosmica —
      { order: 1, locationId: 'loc-dbz-gt-hell', eventId: 'evt-dbz-gt-hell-portal', label: { it: "1 · Inferno — il varco si apre", en: '1 · Hell — the portal opens' }, description: { it: 'Doppio clic su «Terra» per scendere e proseguire sulla mappa principale.', en: "Double-click 'Earth' to go down and continue on the main map." } },
      // — Livello Terra —
      { order: 2, locationId: 'loc-dbz-gero-lab', eventId: 'evt-dbz-gt-super-17-fusion', label: { it: '2 · La fusione: nasce Super C-17', en: '2 · The fusion: Super 17 is born' } },
      { order: 3, locationId: 'loc-dbz-satan-city', eventId: 'evt-dbz-gt-super-17', label: { it: '3 · Satan City — la furia di Super C-17', en: "3 · Satan City — Super 17's rampage" } },
      { order: 4, locationId: 'loc-dbz-lookout', label: { it: '4 · Il Palazzo di Dende', en: "4 · Dende's Lookout" } },
    ],
    color: '#5dade2',
    lineStyle: 'dashed',
    referenceStatus: 'verified',
    tags: ['gt', 'super-17', 'androidi', 'inferno'],
  },
  {
    id: 'route-dbz-gt-shadow-dragons-journey',
    worldId: 'world-dragonball',
    type: 'narrative',
    name: 'Dragon Ball GT · Shadow Dragon Saga',
    localizedName: { it: 'Dragon Ball GT · Saga dei Draghi Malvagi', en: 'Dragon Ball GT · Shadow Dragon Saga' },
    group: { it: 'Dragon Ball GT', en: 'Dragon Ball GT' },
    description: {
      it: "Dragon Ball GT: i sette Draghi Malvagi, nati dall'energia negativa delle Sfere del Drago, emergono in giro per il mondo. Goku e Pan li affrontano uno per uno fino allo scontro finale con Omega Shenron, chiuso dalla Genkidama Universale.",
      en: "Dragon Ball GT: the seven Shadow Dragons, born from the Dragon Balls' negative energy, emerge around the world. Goku and Pan face them one by one up to the final clash with Omega Shenron, ended by the Universal Spirit Bomb.",
    },
    protagonistCharacterIds: ['char-dbz-goku', 'char-dbz-gt-pan'],
    relatedCharacterIds: ['char-dbz-gt-omega-shenron', 'char-dbz-gt-nuova-shenron', 'char-dbz-gogeta'],
    relatedArcIds: ['arc-dbz-gt-shadow-dragons'],
    relatedLocationIds: ['loc-dbz-lookout', 'loc-dbz-kame-house', 'loc-dbz-satan-city'],
    steps: [
      { order: 1, locationId: 'loc-dbz-lookout', eventId: 'evt-dbz-gt-shadow-dragons-emerge', label: { it: '1 · I Draghi Malvagi emergono', en: '1 · The Shadow Dragons emerge' } },
      { order: 2, locationId: 'loc-dbz-kame-house', eventId: 'evt-dbz-gt-nuova-eis', label: { it: '2 · La caccia ai Draghi', en: '2 · Hunting the Dragons' }, description: { it: 'Goku e Pan affrontano i Draghi uno per uno; Nuova Shenron diventa alleato.', en: 'Goku and Pan face the Dragons one by one; Nuova Shenron becomes an ally.' } },
      { order: 3, locationId: 'loc-dbz-satan-city', eventId: 'evt-dbz-gt-goku-final', label: { it: '3 · Scontro finale con Omega Shenron', en: '3 · Final clash with Omega Shenron' }, description: { it: 'Gogeta SS4 e infine la Genkidama Universale sconfiggono Omega Shenron.', en: 'SS4 Gogeta and finally the Universal Spirit Bomb defeat Omega Shenron.' } },
    ],
    color: '#8e44ad',
    lineStyle: 'solid',
    referenceStatus: 'verified',
