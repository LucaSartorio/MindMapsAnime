...
export const it = {
  ...
  map: {
    ...
    story: {
      ...
      prev: 'Evento precedente',
      next: 'Evento successivo',
      play: 'Riproduci',
      pause: 'Pausa',
      close: 'Esci dalla storia',
      empty: 'Questo arco non ha eventi da raccontare.',
      noLocation: 'Evento senza luogo sulla mappa',
    },
    legend: {
      title: 'Legenda',
      village: 'Villaggio',
    ...
    timeline: {
      ...
      expand: '▸ Espandi',
      collapse: '▾ Riduci',
      play: 'Riproduci la timeline',
      pause: 'Pausa',
      resume: 'Riprendi',
      stop: 'Interrompi la riproduzione',
      nowPlaying: 'Riproduzione della timeline',
    },
  ...
  modals: {
    ...
    viewRelations: 'Mappa delle relazioni',
    relations: {
      title: 'Relazioni',
      subtitle: 'Tocca un personaggio per esplorarne i legami',
      openCard: 'Apri scheda',
      empty: 'Nessuna relazione registrata per questo personaggio.',
      list: 'Elenco relazioni',
      graphAria: 'Grafo delle relazioni (rappresentazione visiva)',
      family: 'Famiglia',
      mentor: 'Maestro',
      student: 'Allievo',
      ally: 'Alleato',
    ...
    stepperTitle: 'Segui il percorso',
    stepperPrev: 'Tappa precedente',
    stepperNext: 'Tappa successiva',
    stepperPlay: 'Riproduci',
    stepperPause: 'Pausa',
  ...
  onboarding: {
    ...
    steps: {
      ...
      timeline:
        'Apri la timeline in basso e premi ▶ Riproduci: la mappa ripercorre tutti gli eventi uno per uno, come una storia guidata. Metti in pausa, riprendi o interrompi quando vuoi.',
    },
