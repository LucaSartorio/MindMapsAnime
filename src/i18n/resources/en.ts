...
export const en = {
  ...
  map: {
    ...
    story: {
      ...
      pause: 'Pause',
      close: 'Exit story',
      empty: 'This arc has no events to tell.',
      noLocation: 'Event without a place on the map',
    },
    legend: {
      title: 'Legend',
      village: 'Village',
  ...
  filters: {
    ...
    noneActive: 'No active filters. The map shows every element.',
    clearAll: 'Clear all',
    remove: 'Remove filter: {{name}}',
    resultsCount: '{{count}} places on the map',
    searchCharacters: 'Search character…',
    searchFactions: 'Search faction or clan…',
  ...
  modals: {
    ...
    tabRoutes: 'Routes',
    tabGallery: 'Gallery',
    tabsAria: 'Card sections',
    viewRelations: 'Relationship map',
    relations: {
      title: 'Relationships',
      subtitle: 'Tap a character to explore their connections',
      openCard: 'Open card',
      empty: 'No relationships recorded for this character.',
      list: 'Relationships list',
      graphAria: 'Relationship graph (visual representation)',
      family: 'Family',
      mentor: 'Mentor',
      student: 'Student',
      ally: 'Ally',
    ...
    unverifiedNote:
      'Unverified data: narrative references not yet confirmed against official sources.',
    ...
    stepperTitle: 'Follow the route',
    stepperPrev: 'Previous step',
    stepperNext: 'Next step',
    stepperPlay: 'Play',
    stepperPause: 'Pause',
    mainArc: 'Main arc',
  ...
  onboarding: {
    ...
    steps: {
      ...
      timeline:
        'Open the timeline at the bottom and press ▶ Play: the map walks through every event one by one, like a guided story. Pause, resume or stop whenever you like.',
    },
    cta: 'Start exploring',
  },
  common: {
